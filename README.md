...
## Changelog
See [changelog.md](https://github.com/fcamarlinghi/grunt-cep/blob/master/changelog.md).
...
Once the plugin has been installed, it may be enabled inside your [Gruntfile](http://gruntjs.com/getting-started) as usual:
